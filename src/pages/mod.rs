...
/// ### Why?
///
/// GitHub pages is a cool service and having a personal website could come into use a later date.
/// Also, it is **free**. I can't complain about that. Furthermore, I wanted to try GitHub Actions
/// and see if I can use the Nix Flake to write a GitHub actions script with minimal effort. 
...
/// ### Conclusion
///
/// The purpose of this project wasn't to create a really useful or necessarily practical site.
